...
insert into attends (TripDate, Name) values ('2018-06-01', 'Timmy');
insert into attends (TripDate, Name) values ('2018-05-09', 'Joe');
insert into attends (TripDate, Name) values ('2018-05-09', 'Parikh');
insert into attends (TripDate, Name) values ('2018-05-09', 'Timmy');
